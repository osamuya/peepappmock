...
<div class="panel-group" id="test" role="tablist" aria-multiselectable="false">
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#test" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          Edit
        </a>
      </h4>
    </div>
      ...
      <div class="panel-body">
        <form>
			<div class="form-group">
				<label for="exampleInputEmail1">編集キー</label>
				<input type="email" class="form-control form-half" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="user@example.com">
				<small id="emailHelp" class="form-text text-muted">無効なキーです。</small>
			</div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
		<div class="form-group">
			<label for="exampleInputEmail1">クローズキー</label>
			<input type="email" class="form-control form-half" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="user@example.com">
			<small id="emailHelp" class="form-text text-muted">無効なキーです。</small>
		</div>
		<div class="form-botton last">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      <div class="panel-body">
		<div class="form-group">
			<label for="exampleInputEmail1">削除キー</label>
			<input type="email" class="form-control form-half" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="user@example.com">
			<small id="emailHelp" class="form-text text-muted">無効なキーです。</small>
		</div>
		<div class="form-botton last">
			<button type="submit" class="btn btn-danger">Delete</button>
						...
						<div class="rep first">
							<div class="panel panel-default">
								<div class="panel-heading">名字 名前</div>
