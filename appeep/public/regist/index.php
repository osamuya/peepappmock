				...
				<div class="mform">
					<form>
						<div class="form-group">
							<label for="exampleInputEmail1">お名前(ニックネーム)</label>
							<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="user@example.com">
